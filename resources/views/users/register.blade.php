<x-layout>
    <a class="nav-link text-dark" href="/users/login">Already Have An Account?<span class="text-danger">Let's Login</span>  </a>
    <form class="mt-3" method="POST" action="/users/register" enctype="multipart/form-data">
        @csrf
    ...
    @enderror
      ...
      <div class="form-floating mb-3">
        <input type="password" name="password_confirmation" value="{{old('password')}}" class="form-control" id="floatingInput" >
